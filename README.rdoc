...
Capistrano recipe for installing a crontab on your server from the config/crontabs
directory in your application. Crontabs are ERB templates and have access to all
